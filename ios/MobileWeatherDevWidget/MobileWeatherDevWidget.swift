...
struct MobileWeatherDevWidgetEntryView : View {
...
struct MobileWeatherDevWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        IntentConfiguration(kind: kind, intent: ConfigurationIntent.self, provider: Provider()) { entry in
            MobileWeatherDevWidgetEntryView(entry: entry)
        }
...
struct MobileWeatherDevWidget_Previews: PreviewProvider {
    static var previews: some View {
        MobileWeatherDevWidgetEntryView(entry: SimpleEntry(date: Date(), configuration: ConfigurationIntent()))
