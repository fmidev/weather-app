...
public class ConfigurationActivity extends Activity {
    ...
    public void askLocationPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            if (ActivityCompat.checkSelfPermission(
                    ConfigurationActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) !=
                    PackageManager.PERMISSION_GRANTED
                    || ActivityCompat.checkSelfPermission(
                    ConfigurationActivity.this, Manifest.permission.ACCESS_BACKGROUND_LOCATION) !=
                    PackageManager.PERMISSION_GRANTED) {
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(ConfigurationActivity.this, getString(R.string.denied_positioning),
	...
	private void showAppWidget() {
		...
		if (extras != null) {
            ...
            RadioGroup forecast = (RadioGroup)findViewById(R.id.forecastRadioGroup);
            int selectedForecast = forecast.getCheckedRadioButtonId();

            if (selectedForecast==R.id.optionHoursRadioButton)
                editor.putString("forecast", "hours");
            else
                editor.putString("forecast", "days");
            ...
            if (selectedLocation==-1) {
                editor.clear();
                Toast.makeText(ConfigurationActivity.this, getString(R.string.forecast_location_not_defined),
                        Toast.LENGTH_SHORT).show();
                return;
            }
			...
			Intent startService = new Intent(ConfigurationActivity.this, UpdateWidgetJobIntentService.class);
