...
public class SmallWidgetConfigurationActivity extends Activity {
	...
	public void initListViews() {
        ...
        ActivityCompat.requestPermissions(SmallWidgetConfigurationActivity.this,
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(SmallWidgetConfigurationActivity.this, getString(R.string.denied_positioning),
	...
	private void showAppWidget() {
		...
		if (extras != null) {
            ...
            if (selectedLocation==-1) {
                editor.clear();
                Toast.makeText(SmallWidgetConfigurationActivity.this, getString(R.string.forecast_location_not_defined),
                        Toast.LENGTH_SHORT).show();
                return;
            }
			...
			Intent startService = new Intent(SmallWidgetConfigurationActivity.this, UpdateWidgetJobIntentService.class);
    ...
    public void askLocationPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            if (ActivityCompat.checkSelfPermission(
                    SmallWidgetConfigurationActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) !=
                    PackageManager.PERMISSION_GRANTED
                    || ActivityCompat.checkSelfPermission(
                    SmallWidgetConfigurationActivity.this, Manifest.permission.ACCESS_BACKGROUND_LOCATION) !=
                    PackageManager.PERMISSION_GRANTED) {
